...
|------------|------|---------|
| file://subcharts/intelliscale | intelliscale | 26.4.0 |
...
| image | object | `{"digest":"","pullPolicy":"IfNotPresent","registry":"docker.io/ryaxtech","repository":"worker","tag":"26.4.0"}` | container image name and version |
