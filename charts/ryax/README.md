...
|------------|------|---------|
| file://subcharts/action-builder | action-builder | 26.9.0-rc1 |
| file://subcharts/authorization | authorization | 26.9.0-rc1 |
| file://subcharts/common-resources | common-resources | 26.9.0-rc1 |
| file://subcharts/datastore | datastore | 26.9.0-rc1 |
| file://subcharts/front | front | 26.9.0-rc1 |
| file://subcharts/intelliscale | intelliscale | 26.9.0-rc1 |
| file://subcharts/registry | registry | 26.9.0-rc1 |
| file://subcharts/repository | repository | 26.9.0-rc1 |
| file://subcharts/runner | runner | 26.9.0-rc1 |
| file://subcharts/studio | studio | 26.9.0-rc1 |
...
| kube-prometheus-stack.prometheus.prometheusSpec.storageSpec.volumeClaimTemplate.spec.resources | object | `{"requests":{"storage":"10Gi"}}` | Select a storage class for prometheus metrics storage. The block is passed through `tpl`, so it can reference values. storageClassName: "{{ .Values.global.defaultStorageClass }}" |
