# Deploy your first workflow-based application
...
*For more details on Ryax concepts, take a look here: [Ryax concepts](../concepts/concepts.md)*
...
After entering you repo's name and URL, if your repository is private, you need to enter your credentials to allow access for Ryax to
crawl your repo. For this example, we'll use the following login and password:
- Username: **anonymous**
- Password: **anonymous**
