...
Unfortunatelly, as stated we deprecate the support of ryax-adm, and cluster installed with adm cannot be operated with the new helm charts. To migrate to the new version you can follow the migration documentation.
